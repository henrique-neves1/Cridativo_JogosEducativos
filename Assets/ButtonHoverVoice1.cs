...
public class ButtonHoverVoice1 : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    public void StopHoverSoundImmediately()
    {
