...
public class GenerateMaze : MonoBehaviour
{
    ...
    public MazeEndController yourMazeEndControllerReference;
    ...
    public void CreateMaze()
    {
        ...
        ExitTrigger invisibleTrigger = exitTriggerGO.AddComponent<ExitTrigger>();
    ...
    string savePath => Path.Combine(Application.persistentDataPath, "maze_save.json");
    ...
    public void SaveMazeState(Vector2Int playerPos)
    {
        ...
        var roomList = new List<MazeSaveData.RoomData>();
        ...
        for (int i = 0; i < numX; ++i)
        {
            ...
            {
                Room r = rooms[i, j];
                var rd = new MazeSaveData.RoomData
                {
    ...
    public bool LoadMazeState()
    {
        ...
        MazeSaveData saveData = JsonUtility.FromJson<MazeSaveData>(json);
